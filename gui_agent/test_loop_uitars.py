...
from unified_agent import UITarsAgent, run_all_tests
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run UI-TARS SFT agent via the unified MobileAgent-compatible interface.")
