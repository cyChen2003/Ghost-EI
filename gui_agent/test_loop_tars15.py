...
from unified_agent import TARS15Agent, run_all_tests
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run TARS 1.5 agent via the unified MobileAgent-compatible interface.")
